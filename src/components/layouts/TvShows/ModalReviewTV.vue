<template>
   ...
   <transition name="modal">
    <div class="modal-mask">
      <div class="modal-wrapper"  @click="$emit('closeReviewTV')">
            ...
            onSubmitReview(currentPage) {
                if(this.title && this.content) {
                    this.$store.dispatch("postReview", {
                        ...
                        media_photo: this.currentTvShow[0].photoUrl,
                        media_name: this.currentTvShow[0].name,
                        media_year: this.currentTvShow[0].currentseason,
                        title: this.title,
